...
class ThermalCamera:
    def __init__(self, colormap='inferno'):
        ...
        try:
            self.i2c = busio.I2C(board.SCL, board.SDA, frequency=100000)  # Reduced I2C speed
    ...
    def process_frame(self, frame):
        ...
        # Apply the bilateral filter if enabled
    ...
    def generate_legend(self, width=800, height=200):
        ...
        plt.savefig(f'static/{self.colormap}_legend.png', bbox_inches='tight', pad_inches=0)
        plt.close(fig)
